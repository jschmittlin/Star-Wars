    ...
    if touche == "space":
        ...
        def menu():
            ...
            def jouer(event):
                ...
                item = c.create_rectangle(20, 20, 500 + 20, 70, fill='green')
                ...
                def deplacer_player(event):
                    global x,y, id_player, c  ,fond, menu, score, fenetre_end, police, police1,BGD1,BGD2,imD1,imD2,nm_joueur,score_joueur, entree
                    vitesse_vaisseau = 23
                    ...
                    if control == "Up" or control == "z" :
                        ...
                        bouton_save = Button(zone_bouton)
                        ...
                        bouton_save.configure(text="ENREGISTRER LE PSEUDO",bg="white",fg="black", width="30", height="1", relief=FLAT, font=police)

                        #on définie l'emplacements des boutons
                        bouton_menu.grid(row=8,column=1)    
                        bouton_score1.grid(row=9,column=1)
                        bouton_quit.grid(row=10,column=1)
                        bouton_save.grid(row=7,column=1)
                        ...
                        def save(event):
                            global nom_joueur, score_joueur, nm_joueur, entree
                            
                            nom_joueur = str(entree.get())
                            if nom_joueur != "" and len(str(nom_joueur)) <= 12:
                                ...
                                liste.append([nom_joueur,score_joueur])
                                liste_2 = liste
                        ...
                        bouton_save.bind("<ButtonPress-1>",save)
                            ...
                            if coord[k][0] < coord_missile[g][0] :
                                if coord_missile[g][0] < coord[k][0]+110:
                                    if coord[k][1] < coord_missile[g][1]:
                                        if coord_missile[g][1] < coord[k][1]+110:
                    ...
                    for k in range (len(coord)):
                        if (x < coord[k][0] + 110 and x > coord[k][0]) or (x + 90 > coord[k][0] and x + 90 < coord[k][0] + 110):
                            if (y < coord[k][1] + 197 and y > coord[k][0]) or (y + 108 > coord[k][1] and y + 108 < coord[k][1] + 197):
                                vie_vaisseau -= 10
                                liste_6.append(k)
                                item = c.create_rectangle(20, 20, vie_vaisseau*5 + 20, 70, fill='green')
                                item_2 = c.create_rectangle(vie_vaisseau*5 + 20, 20, 520, 70, fill="maroon")
                ...
                def check_vie():
                    ...
                    if vie_vaisseau <= 0:
                        ...
                        bouton_score1.configure(text="TABLEAUX DES SCORES",bg="white",fg="black", width="30", height="1", relief=FLAT, font=police)
                        bouton_quit.configure(text="QUITTER LE JEU",bg="white",fg="black", width="30", height="1", relief=FLAT, font=police)
                        bouton_save.configure(text="ENREGISTRER VOTRE SCORE",bg="white",fg="black", width="30", height="1", relief=FLAT, font=police)
                        ...
                        etiquette2 = Label(zone_bouton, text="VOUS ETES", font=police1, bg="white", fg="red")
                        etiquette2.configure(width="17")
                        etiquette2.grid(row=0,column=1)
